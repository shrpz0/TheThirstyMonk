...
function Navbar({ isMobile }) {
  ...
  return (
    <nav className='fixed top-0 left-0 flex flex-row justify-center py-4 px-6 md:px-12 w-screen bg-[#a89c8a1c] backdrop-blur-sm z-50 border border-[#ffffff21] select-none'>
