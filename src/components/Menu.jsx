...
function Menu() {
    ...
    return (
      <section id='menu' className='bg-[#181312] py-18 px-12 md:py-[calc(12*var(--vh))] md:min-h-[calc(110*var(--vh))] md:px-[16%] flex flex-col items-center select-none' ref={menuRef}>
